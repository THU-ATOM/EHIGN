...
if __name__ == "__main__":
    ...
    valid_set = GraphDataset(
        valid_dir, valid_df, graph_type="Graph_EHIGN", create=False
    )
    test2013_set = GraphDataset(
        test2013_dir, test2013_df, graph_type="Graph_EHIGN", create=False
    )
    test2016_set = GraphDataset(
        test2016_dir, test2016_df, graph_type="Graph_EHIGN", create=False
    )
    test2019_set = GraphDataset(
        test2019_dir, test2019_df, graph_type="Graph_EHIGN", create=False
    )
    ...
    load_model_dict(
        model,
        "./model/20230120_135757_EHIGN_repeat0/model/epoch-144, train_loss-0.5772, train_rmse-0.7598, valid_rmse-1.1799, valid_pr-0.7718.pt",
    )
    ...
    msg = (
        "valid_rmse-%.4f, valid_pr-%.4f, test2013_rmse-%.4f, test2013_pr-%.4f, test2016_rmse-%.4f, test2016_pr-%.4f, test2019_rmse-%.4f, test2019_pr-%.4f,"
        % (
            valid_rmse,
            valid_pr,
            test2013_rmse,
