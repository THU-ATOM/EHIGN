"""A DGL version of EGNN.

The original EGNN can be found in https://github.com/vgsatorras/egnn According
to the EGNN paper, updating coordinates is unnecessary for those tasks that do
not need to predict vectors.
"""
